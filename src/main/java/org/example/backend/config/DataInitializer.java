...
import org.example.backend.repository.InscriptionRepository;
...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        if (etudiantRepository.count() > 0) {
            System.out.println("=== Données déjà initialisées - Saut de l'initialisation ===");
            System.out.println("Classes existantes: " + classeRepository.count());
            System.out.println("Étudiants existants: " + etudiantRepository.count());
            System.out.println("Inscriptions existantes: " + inscriptionRepository.count());
            System.out.println("Notes existantes: " + noteRepository.count());
            System.out.println("Emplois du temps existants: " + emploiDuTempsRepository.count());
            System.out.println("Cours existants: " + coursRepository.count());
            return;
        }
