...
public class Etudiant {
    ...
    public Etudiant(Long id, String matricule, String nom, String prenom, LocalDate dateNaissance, String nomPere, String nomMere, String telephonePere, String telephoneMere, Integer rang, Classe classe, List<Inscription> inscriptions) {
        this.id = id;
